...
- `Config? config` represents certain configuration parameters for the CommandClient. Defaults to null for the default values.
  ...
  - `AddBotMeCommandInfo` states whether the bot should automatically upload info about its commands to telegram ![AddBotMeCommandInfo Image Example](repo_assets/AddBotMeCommandInfo Image Example.png)
```C# 
